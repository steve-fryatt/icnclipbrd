...
OS_Word					EQU &000007
Territory_ConvertDateAndTime		EQU &04304B
...
PostFilterInsertDateReadTime
	...
	ADD	R2,R1,#10
	MOV	R3,#100
	SWI	Territory_ConvertDateAndTime	; By this point, R4 points to the format string.

	MOV	R4,R0				; Point R4 to the string, and set up R0 and R1 ready for OS_Byte &8A before jumping
	MOV	R0,#&8A				; to the insert text loop.
	MOV	R1,#0
	B	PostFilterPasteReplaceInsert
...
RemoveExtUpdateLoop
	...
	AND	R1,R1,#&7			; Get the flag bit into R0.
	MOV	R0,#1
	MOV	R0,R0,LSL R1
...
HelpString
        DCB     "IcnClipBrd\t0.13 (27 Oct 2007) 32-bit © Thomas Leonard & Stephen Fryatt",0
